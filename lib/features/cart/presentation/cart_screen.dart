...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Removed WidgetRef from signature in actual use, but avoiding signature change error if I can't change call sites yet. Wait, generic build is (context).
    // Actually StatelessWidget build is (context).
