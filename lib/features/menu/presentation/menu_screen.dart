...
class MenuScreen extends ConsumerWidget {
                ...
                children: [
                   ...
                   InkWell(
                     ...
                     child: Container(
                       ...
                       child: Text(
                         selectedTable == null ? 'Pilih meja' : 'Meja ${selectedTable.number}',
                        ...
                        SizedBox(
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return _buildUnavailableCard(product, currencyFormatter);
                            },
                          ),
                        ),
                      ],
                    ...
                    builder: (context, snapshot) {
                      ...
                      return DropdownButtonFormField<RestaurantTable>(
                        ...
                        items: availableTables
                            ...
                            .toList(),
                        onChanged: (value) => setModalState(() => selectedTable = value),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: canSubmit
                              ? () {
                                  ref.read(selectedTableProvider.notifier).state = selectedTable;
                                  ref.read(selectedSeatCountProvider.notifier).state = seatCount;
                                  Navigator.pop(ctx);
                                }
                              : null,
  ...
  Widget _buildUnavailableCard(Product product, NumberFormat currencyFormatter) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(AppDimens.r24),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('Tidak tersedia', style: TextStyle(fontSize: 12)),
                    ),
                  ),
                ],
              ),
