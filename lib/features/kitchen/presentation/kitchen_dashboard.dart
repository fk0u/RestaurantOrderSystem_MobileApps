      ...
      child: Scaffold(
        ...
        body: state.when(
          ...
          data: (orders) {
            ...
            final sortedOrders = [...orders]..sort((a, b) => a.timestamp.compareTo(b.timestamp));
  ...
  Widget _buildOrderList(WidgetRef ref, List<Order> orders) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final durationLabel = minutes < 60 ? '${minutes}m' : '${duration.inHours}j ${minutes % 60}m';
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text('Durasi $durationLabel', style: const TextStyle(fontSize: 12, color: Colors.grey)),
                      ],
                    ),
                  ],
                ),
